...
class _OverlayAppState extends State<OverlayApp> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        role: 'assistant',
        content:
            'Hi! I am EV, your AI assistant. Ask me to perform any task on your screen.',
      ),
    );
  }
  ...
  Future<void> _initializeServices() async {
    ...
    final intent = const AndroidIntent(
      action: 'com.visuallstar.ev.REGISTER_BACKGROUND_CHANNELS',
  ...
  Future<void> _openMainApp() async {
    ...
    const intent = AndroidIntent(
      ...
      package: 'com.visuallstar.ev',
      componentName: 'com.visuallstar.ev.MainActivity',
      flags: <int>[
